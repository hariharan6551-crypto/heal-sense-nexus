// ============================================================================
// ADVANCED STORE — Zustand Global State for Ultra-Premium Enhancement Layer
...
// --- Theme System ---
export type AdvancedTheme = 'dark' | 'neon' | 'light';
...
interface AdvancedState {
  ...
  addNotification: (n: Omit<AdvancedNotification, 'id' | 'timestamp' | 'read'>) => void;
