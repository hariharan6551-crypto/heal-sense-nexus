...
export default function SmartInsightsEngine({ datasetSize = 100, columns = [] }: Props) {
  const { insightsPanelOpen, toggleInsightsPanel } = useNexusStore();
        ...
        >
          <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={toggleInsightsPanel} className="nexus-close-btn">
                <X className="w-4 h-4" />
              </button>
            </div>
                  ...
                  {insights.map((insight, i) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="nexus-metric-card overflow-hidden cursor-pointer"
