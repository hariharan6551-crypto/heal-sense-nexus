...
export default function UltraContainer({ children }: Props) {
  const { particlesEnabled } = useNexusStore();
  ...
  return (
    <div className="nexus-ultra-container nexus-light">
      {/* Ambient glow that follows cursor — subtle warm tint */}
      <div
        className="nexus-cursor-glow"
        style={{
      ...
      {particlesEnabled && (
        <canvas
          ref={canvasRef}
          className="nexus-particle-canvas"
        />
      )}
