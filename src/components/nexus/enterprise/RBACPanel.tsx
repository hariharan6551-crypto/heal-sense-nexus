...
const MOCK_USERS: RBACUser[] = [
  { id: '1', name: 'Dr. Sarah Chen', email: 'sarah.chen@nexus.ai', role: 'admin', status: 'active', lastActive: '2 min ago', avatar: 'SC' },
  { id: '2', name: 'James Wilson', email: 'j.wilson@nexus.ai', role: 'analyst', status: 'active', lastActive: '15 min ago', avatar: 'JW' },
  { id: '3', name: 'Emily Rodriguez', email: 'e.rodriguez@nexus.ai', role: 'editor', status: 'active', lastActive: '1 hour ago', avatar: 'ER' },
  { id: '4', name: 'Michael Park', email: 'm.park@nexus.ai', role: 'viewer', status: 'inactive', lastActive: '3 days ago', avatar: 'MP' },
  { id: '5', name: 'Lisa Thompson', email: 'l.thompson@nexus.ai', role: 'analyst', status: 'suspended', lastActive: '1 week ago', avatar: 'LT' },
];
...
export default function RBACPanel() {
  const { rbacPanelOpen, toggleRBACPanel } = useNexusStore();
        ...
        >
          <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={toggleRBACPanel} className="nexus-close-btn">
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            {activeTab === 'users' ? (
              <>
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                  {[
                    ...
                    <div key={stat.label} className="nexus-metric-card text-center py-3">
                ...
                <div className="space-y-2">
                  {MOCK_USERS.map((user, i) => (
                    <motion.div
                      ...
                      className="nexus-metric-card cursor-pointer"
                    >
                      <div className="flex items-center gap-3">
              ...
              /* Permissions Matrix */
              <div className="nexus-metric-card overflow-hidden">
