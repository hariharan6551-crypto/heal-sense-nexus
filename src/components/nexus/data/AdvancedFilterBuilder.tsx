...
export default function AdvancedFilterBuilder() {
  const { filterBuilderOpen, toggleFilterBuilder } = useNexusStore();
    ...
    <AnimatePresence>
      {filterBuilderOpen && (
        <motion.div
          ...
          className="fixed right-0 top-0 bottom-0 w-[460px] z-[60] nexus-panel-glass overflow-y-auto"
        >
          <div className="p-6">
            {/* Header */}
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex gap-2">
                <button onClick={resetAll} className="nexus-icon-btn" title="Reset">
                  <RotateCcw className="w-4 h-4" />
                </button>
                <button onClick={toggleFilterBuilder} className="nexus-close-btn">
                  <X className="w-4 h-4" />
                </button>
              </div>
            </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    {conditions.length > 1 && (
                      <button
                        ...
                        className="nexus-icon-btn mt-0.5 w-7 h-7 flex-shrink-0 hover:!bg-rose-500/10 hover:!text-rose-400 hover:!border-rose-500/20"
                      >
