...
export default function DrillDownPanel() {
  const { drillDownOpen, toggleDrillDown } = useNexusStore();
        ...
        >
          <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={toggleDrillDown} className="nexus-close-btn">
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <motion.div
              ...
              className="nexus-metric-card mb-4"
            >
              <div className="h-52">
            ...
            <div className="space-y-1.5">
              {level.data.map((item, i) => (
                <motion.div
                  ...
                  className={`nexus-metric-card flex items-center gap-3 ${canDrillDown ? 'cursor-pointer hover:!bg-white/[0.06]' : ''}`}
                >
                  <div
