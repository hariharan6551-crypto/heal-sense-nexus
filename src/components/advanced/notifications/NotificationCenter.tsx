...
export default function NotificationCenter() {
  ...
  return (
    <>
      {/* Bell Button */}
      <button onClick={toggleNotificationPanel} className="advanced-icon-btn relative" title="Notifications">
        ...
        {notificationPanelOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-16 right-4 z-[59] w-[380px] max-h-[500px] rounded-2xl advanced-panel-glass overflow-hidden flex flex-col"
            >
              {/* Header */}
              <div className="flex items-center justify-between px-4 py-3 border-b border-white/5">
                ...
                <div className="flex gap-1">
                  <button onClick={clearNotifications} className="advanced-icon-btn" title="Clear all">
                    <Trash2 className="w-3.5 h-3.5" />
                  </button>
                  <button onClick={toggleNotificationPanel} className="advanced-icon-btn">
