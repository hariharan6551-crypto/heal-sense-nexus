...
const MOCK_ENDPOINTS: APIEndpoint[] = [
  ...
  { id: 'e5', name: 'WebSocket Feed', url: 'wss://stream.advanced.ai', status: 'healthy', latency: 12, uptime: 99.95, lastChecked: '30s ago', requests24h: 45231 },
];
...
export default function APIIntegrationPanel() {
  const { apiPanelOpen, toggleAPIPanel } = useAdvancedStore();
        ...
        >
          <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={toggleAPIPanel} className="advanced-close-btn">
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 mb-4">
              <div className="advanced-metric-card text-center py-3">
                ...
                {MOCK_KEYS.map((apiKey, i) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 bg-white/3 rounded-lg px-3 py-2 mb-2">
                      ...
                      <button onClick={() => setShowKey(showKey === apiKey.id ? null : apiKey.id)} className="advanced-icon-btn w-6 h-6">
                        {showKey === apiKey.id ? <EyeOff className="w-3 h-3" /> : <Eye className="w-3 h-3" />}
                      </button>
                      <button className="advanced-icon-btn w-6 h-6" title="Copy">
