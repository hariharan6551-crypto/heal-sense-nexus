          ...
          <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex gap-2">
                <button className="advanced-icon-btn" title="Export Logs">
                  <Download className="w-4 h-4" />
                </button>
                <button onClick={toggleAuditPanel} className="advanced-close-btn">
                  <X className="w-4 h-4" />
                </button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 gap-2 mb-4">
              {[
                ...
                <div key={stat.label} className="advanced-metric-card text-center py-2">
